        ...
        if "editor.tabSize" in file_content:
            ...
            if tab_size == expected_tab_size and file_content == origin_file_content:
                return [
                    ...
                    {"status": "success", "reason": "Tab size updated without altering other settings"}
                ]
        return [{"status": "error", "type": "evaluate_on_completion", "message": "Settings file content did not match expectations"}]

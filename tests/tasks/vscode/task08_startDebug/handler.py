...
def message_handler(message: Dict[str, Any], logger, task_parameter: Dict[str, Any]) -> Optional[List[Dict[str, Any]]]:    
    ...
    logger.info(message)
    expected_filename = task_parameter.get("file_name", "/workspace/.mcpworld/vscode/C-Plus-Plus/bubble_sort.cpp")
    expected_breakpoints = task_parameter.get("breakpoints", {
        "78": "i==2",
        "80": "None",
        "98": "None"
    })
    expected_hit_file = task_parameter.get("hit_file", "/workspace/.mcpworld/vscode/C-Plus-Plus/bubble_sort.cpp")
